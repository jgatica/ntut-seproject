        ...
        <div id="templatemo_main">
          ...
          <div class="col_w900 hr_divider ">
			...
			<div class="subBottomDiv" ></div>            
				...
				<h2 class="uiHeaderTitle">陳奕豪<img class="arrow_right" src="/images/arrow_right.png" />編輯個人資料</h2>
				<!-- InstanceEndEditable -->
                ...
                <div class="table-content">
					...
					<div id="dialog" title="新增專案">
						...
						<form>
							<tr>
								<td width="40%"><label for="name">專案名稱</label></td>
								<td width="60%"><input type="text" name="name" id="name" class="text ui-widget-content ui-corner-all" /></td>
							</tr>
							<tr>
								<td width="40%"><label for="email">負責人</label></td>
								<td width="60%"><input type="text" name="email" id="email" value="" class="text ui-widget-content ui-corner-all" /></td>
							</tr>
							<tr>
								<td width="40%"><label for="password">開始時間</label></td>
								<td width="60%"><input class="text ui-widget-content ui-corner-all" type="text" name="date" id="date_start" /></td>    
							</tr>
							<tr>
								<td width="40%"><label for="password">結束時間</label></td>
								<td width="60%"><input class="text ui-widget-content ui-corner-all" type="text" name="date" id="date_end" /></td>
							</tr>							
						</form>	
						</table>				
						<!--<p>你確定要刪除該專案嗎?</p>
					...
					<div>
						...
						<table summary="站內信箱">
							...
							<tr>
								<th scope="row">總共</th>
								<td colspan="4">67 封</td>
							</tr>
							</tfoot>
							<tbody>
								<tr>
									<th scope="row" id="r100"><a href="100.php">陳小豪</a></th>
									<td><a href="#">陳大豪</a></td>
									<td>軟工專案</td>
									<td>軟工專案美術部分請加油!! :)</td>
									<td><a href="http://www.adobati.it/labs/CSSTable/0m4r.table.css" title="Download the rows table template CSS file">美術.rar</a></td>
								</tr>
								<tr class="odd">
									<th scope="row" id="r100"><a href="100.php">陳小豪</a></th>
									<td><a href="#">陳大豪</a></td>

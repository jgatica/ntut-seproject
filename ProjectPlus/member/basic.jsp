        ...
        <div id="templatemo_main">
          ...
          <div class="col_w900 hr_divider ">
			...
			<div class="subBottomDiv" ></div>            
				...
				<h2 class="uiHeaderTitle"><span id="nameArea"><%= ((MemberDataStructure)session.getAttribute("userData")).member_name %></span><img class="arrow_right" src="/images/arrow_right.png" /><label langtag="profile-title"></label></h2>
				<!-- InstanceEndEditable -->
                ...
                <div class="table-content">
						...
						<table width="100%">
							...
							<tr>
								...
								<th width="80%" scope="col" langtag="profile-table-info"></th>
							</tr>
							</thead>
							<tfoot>
							<tr>
							...
							<tbody>
								<tr class="odd">
									...
									<td><img id="imageURL" class="bigpic" src="/images/default.jpg"  width="50" height="50"/></td>									
								</tr>							
								<tr>

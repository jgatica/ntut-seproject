          ...
          <div class="col_w900 hr_divider ">
			...
			<div class="subBottomDiv" ></div>            
                ...
                <div class="table-content">
					...
					<div id="dialog" title="上傳圖片">
						<p>修改你的<team>大頭貼</team>，請選擇上傳檔案</p>
						<table>					
						<form>
							<tr>
								<td width="20%"><label for="email">從電腦</label></td>
								<td width="80%"><input type="file" value="" class="text ui-widget-content ui-corner-all" /></td>
							</tr>		
							<tr>
								<td width="20%"><label for="email">從網址</label></td>
								<td width="80%"><input type="text" value="" class="text ui-widget-content ui-corner-all" /></td>
							</tr>																	
						</form>	
						</table>	

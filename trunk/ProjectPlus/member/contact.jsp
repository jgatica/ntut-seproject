        ...
        <div id="templatemo_main">
          ...
          <div class="col_w900 hr_divider ">
			...
			<div class="subBottomDiv" ></div>            
				...
				<h2 class="uiHeaderTitle"><span id="nameArea"><%= ((MemberDataStructure)session.getAttribute("userData")).member_name %></span><img class="arrow_right" src="/images/arrow_right.png" />聯絡資料</h2>
				<!-- InstanceEndEditable -->

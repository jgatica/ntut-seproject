        ...
        <div id="templatemo_main">
          ...
          <div class="col_w900 hr_divider ">
			...
			<div class="subBottomDiv" ></div>            
				...
				<h2 class="uiHeaderTitle">陳奕豪<img class="arrow_right" src="/images/arrow_right.png" />當前處理任務</h2>
				<!-- InstanceEndEditable -->
                ...
                <div class="table-content">
					<table summary="站內信箱" width="100%">
						...
						<thead>
						<tr>
							<th width="14%" scope="col">專案編號</th>
							<th width="67%" scope="col">專案內容</th>
							<th width="19%" scope="col">查看</th>
						</tr>
						</thead>
						<tfoot>
						<tr>
						...
						<tbody id="taskArea">
							<tr>
								...
								<td><button class="dialog_btn">查看任務</button></td>								
							</tr>
							<tr class="odd">									
								<td>002</td>
								<td><team>軟體工程</team>專案任務1</td>	

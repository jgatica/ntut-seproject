...
<a href="index.html"><img id="logo" src="img/logo.png" alt="Nova" /></a>
			...
			<div id="main">
                ...
                <div id="content">
                    <div id="page-content">
						<div class="one-half">						
                            <h6 class="information-box">修改專案</h6>                            
                            <div class="orange-no-box">
                                <p>專案名稱 : <input type="text" value="軟體工程專案"/></p>
                                <p>專案描述 : 

                                </p> 
                                <p>                                
                                <textarea rows="6" cols="40">軟體工程專案預估系統是一個非常有趣的題目，希望能在這學期好好地完成這項作品。</textarea>
                                </p>
                                <a id="compute" class="link-button">確認修改</a>           
                            </div>
                        </div>
                    </div>
                </div>
